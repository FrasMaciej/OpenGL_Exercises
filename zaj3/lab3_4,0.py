...
def render(time):
    ...
    # xeye (R, 𝜃, 𝜑) = R · cos (𝜃) · cos (𝜑) ,
    # yeye (R, 𝜃, 𝜑) = R · sin (𝜑) ,
    # zeye (R, 𝜃, 𝜑) = R · sin (𝜃) · cos (𝜑) .

    viewer[0] = R * math.cos(theta*(math.pi/180)) * math.cos(phi*(math.pi/180))
    viewer[1] = R * math.sin(phi*(math.pi/180))
    viewer[2] = R * math.sin(theta*(math.pi/180)) * math.cos(phi*(math.pi/180))
